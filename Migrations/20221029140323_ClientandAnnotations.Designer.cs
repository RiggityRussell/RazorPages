...
namespace RazorPages.Migrations
{
    ...
    [Migration("20221029140323_ClientandAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2022, 10, 29, 10, 3, 22, 655, DateTimeKind.Local).AddTicks(4227),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2022, 10, 29, 10, 3, 22, 658, DateTimeKind.Local).AddTicks(6062),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2022, 10, 29, 10, 3, 22, 658, DateTimeKind.Local).AddTicks(6118),
                            ServicesID = 5
                        });
                });
