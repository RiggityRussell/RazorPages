    ...
    public partial class ClientandAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2022, 10, 29, 10, 3, 22, 655, DateTimeKind.Local).AddTicks(4227), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2022, 10, 29, 10, 3, 22, 658, DateTimeKind.Local).AddTicks(6118), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2022, 10, 29, 10, 3, 22, 658, DateTimeKind.Local).AddTicks(6062), 7 });
